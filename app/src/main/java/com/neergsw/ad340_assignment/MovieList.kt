...
import com.neergsw.recltest.MovieAdapter
...
class MovieList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = MovieAdapter(this, theList) {
            val intent = Intent(this, MovieDetails::class.java) //two arguments
...
//backButton
        ...
        //!! is  non-null type
        backButton!!.title = "Zombie Movies"
